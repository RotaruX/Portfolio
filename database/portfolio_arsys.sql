-- ============================================================
-- PORTFOLIO DB - Script para PRODUCCIÓN (Arsys)
-- ============================================================
-- Este script crea las tablas en la base de datos de Arsys.
-- En Arsys la base de datos ya está creada (qaqu742),
-- así que NO hacemos CREATE DATABASE ni USE.
-- Ejecutar este archivo en phpMyAdmin de Arsys.
-- ============================================================
