...
(
  ...
  'Recién graduado del Grado Superior en Desarrollo de Aplicaciones Web (DAW). Soy un desarrollador apasionado por crear experiencias digitales excepcionales, con conocimientos sólidos tanto en el frontend como en el backend. Mi enfoque se centra en escribir código limpio, mantenible y eficiente, siempre buscando aprender y aplicar las mejores prácticas y tecnologías más actuales.',
  'alexandru.rotaru@email.com',
  '+34 600 000 000',
  'España',
